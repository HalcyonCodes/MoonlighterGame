class SellBrowsingToolModel {
  String? code;
  String? message;
  SellBrowsingToolData? data;

  SellBrowsingToolModel();

  SellBrowsingToolModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    if(json['data'] != null){
      data = SellBrowsingToolData.fromJson(json['data']);
    }
  }
}

class SellBrowsingToolData {
  List<Role>? roles;

  SellBrowsingToolData();

  SellBrowsingToolData.fromJson(Map<String, dynamic> json) {
    roles = [];
    if (json['roles'] != null) {
