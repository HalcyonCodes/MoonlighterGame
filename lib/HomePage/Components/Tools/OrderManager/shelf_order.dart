...
import './item_price_input.dart';

//制作订单
class ShelfOrder extends StatefulWidget {
  final String? orderId;
  final String? sourceId;
  final String? targetId;


  const ShelfOrder({super.key, this.orderId, this.sourceId, this.targetId});

  @override
  State<ShelfOrder> createState() => _ShelfOrderState();
}

class _ShelfOrderState extends State<ShelfOrder> {
  String? orderId;
  String? sourceId;
  String? targetId;
