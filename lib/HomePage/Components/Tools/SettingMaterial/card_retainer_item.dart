...
class _ItemRetainerCardState extends State<ItemRetainerCard> {
  ...
  void initState() {
    ...
    //注册
    widget.toolUtil!
        .addListFuncSetItemBrowsingRetainerCardSelected(setIsSelect);
    //print(widget.toolUtil!.listFuncSetItemBrowsingRetainerCardSelected!.length);
  }
  ...
  void dispose() {
    ...
    widget.toolUtil!
        .removeListFuncSetItemBrowsingRetainerCardSelected(setIsSelect);
  }
}
